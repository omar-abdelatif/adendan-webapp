                ...
                @elseif ($association->name === 'اللجنة الثقافية و الفنية')
                    <div class="col-lg-6">
                        <div class="about-details" dir="rtl">
                            <h2 class="details-title text-center mb-4">الرؤية و المهام</h2>
                            <p class="fs-5">
                                تسعى اللجنة الثقافية و الفنية في جمعية أدندان الخيرية إلى أن تكون رائدة في تعزيز وحفظ التراث الثقافي النوبي، وتعزيز التعبير الفني كوسيلة لتعزيز التواصل والوحدة الاجتماعية في المجتمع النوبي.
                            </p>
                            <p class="fs-5 fw-bold">
                                و من مهام اللجنة:
                                <ul>
