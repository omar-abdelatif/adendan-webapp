            ...
            <div class="row justify-content-center align-items-center">
                    ...
                    <div class="footer-item">
                        ...
                        <div class="footer-item-body">
                            ...
                            <div class="contact-item mb-3 text-center d-flex align-items-center">
                                ...
                                <p class="mb-0 text-secondary fs-5 me-3 fw-bold">١٥ شارع المنوفى، عابدين، القاهرة، مصر</p>
                            </div>
                            <div class="contact-item mb-3 text-center d-flex align-items-center">
                                <i class="fa-solid fa-at fs-5 bg-primary p-3 rounded-pill text-white"></i>
                                <p class="mb-0 text-secondary fs-5 me-3 fw-bold">adandanassociation568@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-12">
                    <div class="footer-item">
                        ...
                        <div class="fb-page" data-href="https://www.facebook.com/adandanassociation568" data-tabs="" data-width="400" data-height="150" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="false">
