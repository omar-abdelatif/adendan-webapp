                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <table class="table display align-middle table-hover text-center text-muted" data-order='[[0,"asc"]]' data-page-length="10">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center">رقم العضوية</th>
                                                        ...
                                                        @foreach ($oldelays as $delay)
                                                            @if ($delay->delay_remaining === 0)
                                                                <tr>
                                                                    <tr>
                                                                        <td colspan="5">
                                                                            <h1 class="text-center mb-0">تم تسديد متأخرات الإشتراكات</h1>
                                                                        </td>
                                                                    </tr>
                                                                </tr>
                                                            @else
