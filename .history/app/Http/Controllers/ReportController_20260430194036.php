...
class ReportController extends Controller {
    ...
    public function safe() {
        ...
        $subscriptionsReports = PaymentTransaction::whereIn('transaction_type', ['إشتراكات', 'إشتراك جديد'])->get();
        $sumSubscriptions = $subscriptionsReports->sum('amount');
        $safeAmounts = [];
        foreach ($totalSafe as $safe) {
            $safeAmounts[] = $safe->amount;
        }
        return view('pages.reports.safe', compact('safeAmounts', 'safes', 'sumDonationsAmount', 'sumSubscriptions'));
    }
    //! Bank
