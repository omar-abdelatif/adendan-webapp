...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.reports.subscriptions', compact('subscribers', 'subscriptions', 'count', 'sumTotalSubscriptionDues', 'sumDueDonationAmount', 'subscriptionSumDuePaied', 'currentSubscriptionYear'));
    }
