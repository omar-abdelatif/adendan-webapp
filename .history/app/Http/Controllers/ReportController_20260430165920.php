...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        $sumTotalCurrentSubscriptionDues = (int) Due::where('transaction_type', 'إشتراك')->whereYear('item', $currentSubscriptionYear)->sum('amount_remaining');
