...
class ReportController extends Controller {
    ...
    public function safe() {
        ...
        $sumDonationsReports = PaymentTransaction::where('transaction_type', 'تبرعات')->sum('amount');
        $Donations = $donationsReports->sum('amount');
        ...
        return view('pages.reports.safe', compact('safeAmounts', 'safes', 'sumDonationsReports', 'sumSubscriptions'));
    }
    //! Bank
