...
class ReportController extends Controller
{
    ...
    public function safe()
    {
        ...
        $sumDonationsAmount = $transactions->where('transaction_type', 'تبرعات')->sum('amount');
        $sumSubscriptionsAmount = $transactions->where('transaction_type', 'اشتراك')->sum('amount');
        $totalSafeAmount = $transactions->sum('amount');
