...
class ReportController extends Controller {
    ...
    public function index() {
        ...
        $sumTotalOldDelaysSubscriptions = Due::where('transaction_type', 'إشتراك')->sum('amount_remaining');
        $sumDueDonationAmount = PaymentTransaction::where('transaction_type', 'تبرعات')->sum('total_amount');
        $sumDelayPaied = PaymentTransaction::where('transaction_type', 'إشتراك')->sum('amount_remaining');
        return view('pages.reports.subscriptions', compact('subscribers', 'subscriptions', 'count', 'sumTotalOldDelaysSubscriptions', 'sumDueDonationAmount', 'sumTotalDelays', 'sumDelayPaied'));
    }
