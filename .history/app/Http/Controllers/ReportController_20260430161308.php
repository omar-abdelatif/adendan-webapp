...
class ReportController extends Controller {
    ...
    public function search(Request $request) {
        ...
        $query = Subscribers::select('subscribers.name', 'subscribers.member_id')->join('olddelays', 'subscribers.member_id', '=', 'olddelays.member_id')->where('olddelays.old_delay_type', 'إشتراكات')->selectRaw('olddelays.amount, olddelays.delay_amount, olddelays.delay_remaining');
