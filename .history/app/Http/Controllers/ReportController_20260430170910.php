...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        $sumTotalCurrentSubscriptionDues = (int) Due::where('transaction_type', 'إشتراك')->where('item', $currentSubscriptionYear)->sum('total_amount');
        $sumTotalCurrentSubscriptionDuesPaid = (int) PaymentTransaction::where('transaction_type', 'اشتراك')->whereYear('item', $currentSubscriptionYear)->sum('amount');
        dd($sumTotalCurrentSubscriptionDuesPaid);
