...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        $currentYear = $this->currentSubscriptionYear();
        $sumTotalCurrentSubscriptionDuesPaied = ($table->integer('votes')->unsigned()->nullable()->default(12);) PaymentTransaction::where('transaction_type', 'اشتراك')->whereYear('item', $currentYear)->sum('amount');
        dd($sumTotalCurrentSubscriptionDuesPaied);
        return view('pages.reports.subscriptions', compact('subscribers', 'subscriptions', 'count', 'sumTotalSubscriptionDues', 'sumDueDonationAmount', 'subscriptionSumDuePaied', 'currentYear', 'currentSubscriptionYear'));
    }
