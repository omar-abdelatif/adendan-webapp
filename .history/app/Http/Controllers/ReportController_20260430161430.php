...
class ReportController extends Controller {
    ...
    public function search(Request $request) {
        ...
        $query = Subscribers::select('subscribers.name', 'subscribers.member_id')
            ->join('olddelays', 'subscribers.member_id', '=', 'dues.member_id')
            ->where('dues.traansaction_type', 'إشتراك')
            ->selectRaw('dues.total_amount, dues.amount_paid, dues.amount_remaining');
