...
class ReportController extends Controller {
    ...
    public function index() {
        ...
        $TotalOldDelays = Due::where('transaction_type', 'إشتراكات')->sum('amount');
        $sumTotalOldDelaysSubscriptions = $TotalOldDelays->;
        $sumDelayAmount = PaymentTransaction::where('transaction_type', 'متأخرات')->sum('amount');
        $sumDelayPaied = PaymentTransaction::where('transaction_type', 'إشتراكات')->sum('amount');
