...
class ReportController extends Controller
{
    ...
    public function index()
    {
        ...
        $sumTotalCurrentSubscriptionDues = Due::where('transaction_type', 'إشتراك')->whereYear('created_at', $currentSubscriptionYear)->sum('amount_remaining');
        ...
        // dd($sumTotalCurrentSubscriptionDuesPaied);
        return view('pages.reports.subscriptions', compact('subscribers', 'subscriptions', 'count', 'sumTotalSubscriptionDues', 'sumDueDonationAmount', 'subscriptionSumDuePaied', 'currentSubscriptionYear', 'currentSubscriptionYear'));
    }
