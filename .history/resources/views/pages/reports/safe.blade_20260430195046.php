            ...
            <div class="col-xxl-6 col-xl-6 box-col-12">
                <div class="card widget-1">
                    <div class="card-body align-items-center">
                        ...
                        <div class="font-Info">
                            <h5 class="mb-1 text-muted">{{ number_format($sumDonationsAmount) }} ج.م</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xxl-6 col-xl-6 box-col-12">
                <div class="card widget-1 ">
                    <div class="card-body align-items-center">
                        ...
                        <div class="font-Info">
                            <h5 class="mb-1 text-muted">{{number_format($sumSubscriptionsAmount)}} ج.م</h5>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    @foreach ($transactions as $transaction)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($transaction->transaction_type === 'تبرعات' || $transaction->transaction_type === 'إشتراكات' || $transaction->transaction_type === 'متأخرات' || $transaction->transaction_type === 'بنك/سحب' || $transaction->transaction_type === 'متأخرات التبرعات' || $transaction->transaction_type === 'تبرع كلي' || $transaction->transaction_type === 'تبرع جزئي'|| $transaction->transaction_type === 'خزنة/إيداع' || $transaction->transaction_type === 'إشتراك جديد')
                                            ...
                                            <td class="text-center">
                                                <h6>{{$transaction->safe->amount}} ج.م</h6>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
