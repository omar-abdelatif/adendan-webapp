                                            ...
                                            <tbody>
                                                @foreach($queryResult as $subscriber)
                                                    <tr>
                                                        ...
                                                        <td>{{ $subscriber->item }}</td>
                                                        <td>{{ $subscriber->total_amount }}</td>
                                                        <td>
                                                            @if ($subscriber->amount_paid)
                                                                {{$subscriber->amount_paid}}
                                                            @else
                                                                <span class="fw-bold">-</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            @if ($subscriber->amount_remaining)
                                                                {{$subscriber->amount_remaining}}
                                                            @else
                                                                <span class="fw-bold">-</span>
                                                            @endif
                                                        </td>
