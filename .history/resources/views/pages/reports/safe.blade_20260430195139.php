                                    ...
                                    @foreach ($transactions as $transaction)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($transaction->transaction_type === 'تبرعات' || $transaction->transaction_type === 'إشتراك' || $transaction->transaction_type === 'بنك/سحب' || $transaction->transaction_type === 'بنك/سحب' || $transaction->transaction_type === 'خز' || $transaction->transaction_type === 'تبرع كلي' || $transaction->transaction_type === 'تبرع جزئي'|| $transaction->transaction_type === 'خزنة/إيداع' || $transaction->transaction_type === 'إشتراك جديد')
