            ...
            q = function () {
                "rtl" === o.settings.direction
                    ? (0 <= parseInt(c.css("marginRight"), 10) &&
                          ...
                          c
                              .find("li:last-child")
                              .insertBefore(c.find("li:first-child"))),
        ...
        (o.init = function () {
            if (
                ...
                s.css({
                    ...
                    "line-height":
                        o.settings.height - 2 * o.settings.borderWidth + "px",
                            ...
                            ? (((a = new XMLHttpRequest()).onreadystatechange =
                                  function () {
                                      if (
                                          ...
                                          var s = "";
                                          void 0 !==
                                              o.settings.source.seperator &&
                                              void 0 !==
                                                  typeof o.settings.source
                                                      .seperator &&
